...
#define CM0_SYSTICK_CTRL    (*((volatile TBase32 *)0xE000E010))  /* SysTick Ctrl & Status Reg.       */
#define CM0_SYSTICK_RELOAD  (*((volatile TBase32 *)0xE000E014))  /* SysTick Reload  Value Reg.       */
#define CM0_SYSTICK_CURRENT (*((volatile TBase32 *)0xE000E018))  /* SysTick CurrentThread Value Reg. */
#define CM0_SYSTICK_CAL     (*((volatile TBase32 *)0xE000E01C))  /* SysTick Cal     Value Reg.       */
...
TBase32 OsCpuCalcHiPRIO(TBase32 data)
{
    int i = 0;
    while(!(data & 0x1))
    {
