...
#define CM4_SYSTICK_CTRL     (0xE000E010)
#define CM4_SYSTICK_CLKSRC   (0x00000004)   /* Clock Source.                    */
#define CM4_SYSTICK_INTEN    (0x00000002)   /* Interrupt enable.                */
#define CM4_SYSTICK_ENABLE   (0x00000001)   /* Counter mode.                    */

/* SysTick Reload  Value Reg.          */
#define CM4_SYSTICK_RELOAD   (0xE000E014)

/* SysTick Current Value Reg.          */
#define CM4_SYSTICK_CURRENT  (0xE000E018)

/* SysTick Cal     Value Reg.          */
#define CM4_SYSTICK_TENMS    (0xE000E01C)

/* Interrupt control & state register. */
#define CM4_ICSR             (0xE000ED04)
#define CM4_ICSR_PENDSVSET   (0x1<<28)       /* Value to trigger PendSV exception.  */
#define CM4_ICSR_PENDSVCLR   (0x1<<27)       /* Value to clear PendSV exception.    */
#define CM4_ICSR_PENDSTSET   (0x1<<26)       /* Value to trigger PendST exception.  */
#define CM4_ICSR_PENDSTCLR   (0x1<<25)       /* Value to clear PendST exception.    */

/* PendSV priority register            */
#define CM4_PRIO_PENDSV      (0xE000ED22)
#define CM4_PENDSV_PRIORITY  (0xFF)
...
void OsCpuStartTickClock(void)
{
    ...
    TCLM_SET_REG32(CM4_SYSTICK_RELOAD, value - 1U);
    TCLM_SET_REG32(CM4_SYSTICK_CTRL, CM4_SYSTICK_CLKSRC|CM4_SYSTICK_INTEN|CM4_SYSTICK_ENABLE);
}
...
{
    TCLM_SET_REG32(CM4_ICSR, CM4_ICSR_PENDSVSET);
}
...
{
    TCLM_SET_REG32(CM4_ICSR, CM4_ICSR_PENDSVCLR);
}
...
{
    /* 配置PENDSV中断优先级 */
    TCLM_SET_REG32(CM4_PRIO_PENDSV, CM4_PENDSV_PRIORITY);
}
