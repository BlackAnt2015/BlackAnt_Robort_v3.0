...
#define CM3_NVIC_CTRL    (*((volatile TBase32 *)0xE000E010))   /* SysTick Ctrl & Status Reg. */
#define CM3_NVIC_RELOAD  (*((volatile TBase32 *)0xE000E014))   /* SysTick Reload  Value Reg. */
#define CM3_NVIC_CURRENT (*((volatile TBase32 *)0xE000E018))   /* SysTick CurrentThread Value Reg. */
#define CM3_NVIC_CAL     (*((volatile TBase32 *)0xE000E01C))   /* SysTick Cal     Value Reg. */
