...
extern TState TclCreateFlags(TFlags* pFlags, TChar* pName, TBitMask property, TError* pError);
...
extern TState TclReceiveFlags(TFlags* pFlags, TBitMask* pPattern, TBitMask option,
