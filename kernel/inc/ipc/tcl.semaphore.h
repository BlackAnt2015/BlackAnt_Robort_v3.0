...
struct SemaphoreDef
{
    TBitMask  Property;         /* 队列中线程的调度策略等属性配置     */
...
extern TState TclObtainSemaphore(TSemaphore* pSemaphore, TBitMask option, TTimeTick timeo,
                                 TError* pError);
extern TState TclReleaseSemaphore(TSemaphore* pSemaphore, TBitMask option, TTimeTick timeo,
                                  TError* pError);
